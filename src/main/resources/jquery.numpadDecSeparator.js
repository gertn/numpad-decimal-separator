 ...
 * 
 * @author Gert Nuyens
 * @version 1.0.1 Dual licensed under the MIT (MIT-LICENSE.txt) or GPL Version 2
 *          licenses (GPL-LICENSE.txt).
 * 
 * Dependencies: - jQuery (http://jquery.com)
 * 
 * jQuery extension functions: - numpadDecSeparator this function has two
 * options: 1) separator: the separator to use when a user presses the numpad
 * decimal separator key. Only use this when the option useRegionalSettings is
 * false. Defaults to ','. 2) useRegionalSettings: when a user presses the
 * numpad decimal separator key it will use the regional options of the
 * operating system. This only works in firefox and ie!!! Defaults to false. -
